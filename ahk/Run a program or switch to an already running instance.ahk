...
; Example uses...
^Numpad1::RunOrActivate("D:\Program Files (x86)\Everything\Everything.exe","Everything")
^Numpad0::RunOrActivate("C:\Documents and Settings\Administrator\Local Settings\Application Data\Youdao\Dict\Application\YodaoDict.exe")